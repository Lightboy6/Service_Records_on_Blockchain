...
if st.button("Input Log"):
    ...
    new_block = Block(vehicle_vin= input_vehicle_vin, odometer=input_odometer_reading, service_provider=input_service_tech, service_reports=input_service, prev_hash=prev_block_hash)
